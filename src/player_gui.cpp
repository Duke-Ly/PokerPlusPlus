...
void player_bet_entry_activate()
{
    if (window)
    {
        if (player_bet_entry)
        {
            cout << "$" + player_bet_entry->get_text() + " bet was set.\n\n";
        }
    }
}
...
void on_all_in_button_clicked()
{
    ...
    {
        if (button_all_in)
            cout << "All-in Button was clicked.\n\n";
    }
}
...
void on_replace_button_clicked()
{
    ...
    {
        if (button_replace)
            cout << "Replace Button was clicked.\n\n";
    }
}

void Player_GUI::run(int argc, char* argv[])
{
